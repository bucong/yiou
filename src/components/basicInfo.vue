<template>
  <div class="basic-info">
    <ul>
      <li>
        <input type="text" name="" id="" value="" placeholder="请输入您的姓名" />
      </li>
      <li>
        <input type="text" name="" id="" value="" placeholder="请输入18位的身份证号码" />
      </li>
      <li>
        <input type="text" name="" id="" value="" placeholder="请输入您的公司名称" />
      </li>
    </ul>
    <section>
